...
export default function VissionMissionCard({ activeTabs }: Props) {
  const data = {
    visi: 'Menjadikan masyarakat yang berkeadilan, berkeadaban, dan berdaya saing, melalui penguatan nilai-nilai agama, partisipasi aktif dalam kegiatan sosial, serta pemberdayaan Lelaki',
    misi: [
      {
