...
export default function VisiMisiSection({}: Props) {
  return (
    <section
      className='p-container flex flex-col items-center justify-between gap-10 bg-bg_secondary py-20'
      id='Program'
    >
      <div className='mb-10 flex flex-col items-center  justify-center gap-2'>
        ...
        <h2 className='text-center text-lg text-slate-500 md:text-xl'>
          Dalam perjalanan menuju kesejahteraan masyarakat, Iqbal berkomitmen
          Untuk
        </h2>
      </div>
      <Tabs />
